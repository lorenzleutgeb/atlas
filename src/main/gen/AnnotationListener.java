...
public interface AnnotationListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by the {@code nonEmptyAnnotation}
	...
	/**
	 * Exit a parse tree produced by the {@code nonEmptyAnnotation}
	 * labeled alternative in {@link AnnotationParser#annotation}.
	 * @param ctx the parse tree
	 */
	void exitNonEmptyAnnotation(AnnotationParser.NonEmptyAnnotationContext ctx);
	/**
	 * Enter a parse tree produced by the {@code zeroAnnotation}
	 * labeled alternative in {@link AnnotationParser#annotation}.
	 * @param ctx the parse tree
	 */
	void enterZeroAnnotation(AnnotationParser.ZeroAnnotationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code zeroAnnotation}
	 * labeled alternative in {@link AnnotationParser#annotation}.
	 * @param ctx the parse tree
	 */
