...
public interface AnnotationVisitor<T> extends ParseTreeVisitor<T> {
  /**
   * Visit a parse tree produced by the {@code nonEmptyAnnotation} labeled alternative in {@link
  ...
  /**
   * Visit a parse tree produced by the {@code zeroAnnotation} labeled alternative in {@link
   * AnnotationParser#annotation}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code nat} labeled alternative in {@link
  ...
  /**
   * Visit a parse tree produced by the {@code rat} labeled alternative in {@link
   * AnnotationParser#number}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code rankIndex} labeled alternative in {@link
  ...
  /**
   * Visit a parse tree produced by the {@code otherIndex} labeled alternative in {@link
   * AnnotationParser#index}.
   *
   * @param ctx the parse tree
   * @return the visitor result
