...
public class AnnotationParser extends Parser {
  ...
  public static final int RULE_annotation = 0,
      RULE_annotationEntry = 1,
      RULE_number = 2,
      RULE_index = 3;

  private static String[] makeRuleNames() {
    return new String[] {"annotation", "annotationEntry", "number", "index"};
  }
  ...
  public static class NonEmptyAnnotationContext extends AnnotationContext {
    ...
    public TerminalNode SQUARE_OPEN() {
      return getToken(AnnotationParser.SQUARE_OPEN, 0);
    }

    public TerminalNode SQUARE_CLOSE() {
      return getToken(AnnotationParser.SQUARE_CLOSE, 0);
    }
    ...
    public List<TerminalNode> COMMA() {
      return getTokens(AnnotationParser.COMMA);
    }
    ...
    public NonEmptyAnnotationContext(AnnotationContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).enterNonEmptyAnnotation(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).exitNonEmptyAnnotation(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnnotationVisitor)
        return ((AnnotationVisitor<? extends T>) visitor).visitNonEmptyAnnotation(this);
  ...
  public static class ZeroAnnotationContext extends AnnotationContext {
    ...
    public ZeroAnnotationContext(AnnotationContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).enterZeroAnnotation(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).exitZeroAnnotation(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnnotationVisitor)
        return ((AnnotationVisitor<? extends T>) visitor).visitZeroAnnotation(this);
      else return visitor.visitChildren(this);
    }
  }
      ...
      switch (getInterpreter().adaptivePredict(_input, 1, _ctx)) {
        case 1:
          ...
          enterOuterAlt(_localctx, 1);
          {
            ...
            ((NonEmptyAnnotationContext) _localctx)
                .entries.add(((NonEmptyAnnotationContext) _localctx).annotationEntry);
            setState(14);
            _errHandler.sync(this);
            _la = _input.LA(1);
            while (_la == COMMA) {
  ...
  public static class AnnotationEntryContext extends ParserRuleContext {
    ...
    public TerminalNode MAPSTO() {
      return getToken(AnnotationParser.MAPSTO, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_annotationEntry;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).enterAnnotationEntry(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).exitAnnotationEntry(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnnotationVisitor)
        return ((AnnotationVisitor<? extends T>) visitor).visitAnnotationEntry(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class NatContext extends NumberContext {
    public TerminalNode NUMBER() {
      return getToken(AnnotationParser.NUMBER, 0);
    }

    public NatContext(NumberContext ctx) {
      copyFrom(ctx);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnnotationVisitor)
        return ((AnnotationVisitor<? extends T>) visitor).visitNat(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class RatContext extends NumberContext {
    ...
    public TerminalNode SLASH() {
      return getToken(AnnotationParser.SLASH, 0);
    }

    public List<TerminalNode> NUMBER() {
      return getTokens(AnnotationParser.NUMBER);
    }
    ...
    public RatContext(NumberContext ctx) {
      copyFrom(ctx);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnnotationVisitor)
        return ((AnnotationVisitor<? extends T>) visitor).visitRat(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class RankIndexContext extends IndexContext {
    ...
    public RankIndexContext(IndexContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).enterRankIndex(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).exitRankIndex(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnnotationVisitor)
        return ((AnnotationVisitor<? extends T>) visitor).visitRankIndex(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class OtherIndexContext extends IndexContext {
    ...
    public TerminalNode PAREN_OPEN() {
      return getToken(AnnotationParser.PAREN_OPEN, 0);
    }

    public TerminalNode PAREN_CLOSE() {
      return getToken(AnnotationParser.PAREN_CLOSE, 0);
    }
    ...
    public OtherIndexContext(IndexContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).enterOtherIndex(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof AnnotationListener)
        ((AnnotationListener) listener).exitOtherIndex(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof AnnotationVisitor)
        return ((AnnotationVisitor<? extends T>) visitor).visitOtherIndex(this);
      else return visitor.visitChildren(this);
    }
  }
              ...
              {
                {
                  ...
                  ((OtherIndexContext) _localctx)
                      .elements.add(((OtherIndexContext) _localctx).NUMBER);
                }
              }
              setState(40);
              _errHandler.sync(this);
